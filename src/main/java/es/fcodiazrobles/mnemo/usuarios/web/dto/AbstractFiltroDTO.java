...
public abstract class AbstractFiltroDTO {
    ...
    @ApiModelProperty(name="limit", value = "Tamaño de la pagina de los resultados", example = "1", required = true)
    @NotNull
    @Min(1)
    ...
    @ApiModelProperty(name = "campoSort", value = "Campo por el que se ordena", example = "id", required = true)
    @NotBlank
